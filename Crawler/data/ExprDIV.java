3
https://raw.githubusercontent.com/RhenaudTheLukark/Lea2C/master/src/fr/ubordeaux/deptinfo/compilation/lea/abstract_syntax/ExprDIV.java
...
public class ExprDIV extends ExprBinary {
	...
	public ExprDIV(Expr left, Expr right, int line, int column) throws Exception {
	...
	public Object constEval(Environment<ExprVALUE> environment) throws EnvironmentException, TypeException {
		...
		if ((o1 instanceof Integer) && (o2 instanceof Integer)) 
			return new Float((Integer)o1 / (Integer)o2);
