4
https://raw.githubusercontent.com/Ethpera/ScrabbleJava/master/src/Plateau.java

public class Plateau {
	/* === Paramčtres de classe === */
	...
	public void modifierPlateau(int[] mot, int xPos, int yPos, Boolean horizontal) {
		if (horizontal) { // Movement soulement dans le axis Y
			for (int i = yPos; i < (yPos + mot.length); ++i) // Bouge de yPos ŕ (yPos + taille de la mot)
			...
			for (int i = xPos; i < (xPos + mot.length); ++i) // Bouge de xPos ŕ (xPos + taille de la mot)
