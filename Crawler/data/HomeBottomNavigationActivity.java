14
https://raw.githubusercontent.com/FanChael/MVVM/master/modules/module_home/src/main/java/com/hl/modules_home/HomeBottomNavigationActivity.java
...
import com.hl.base_module.util.bottomnavigation.BottomNavigationViewHelper;
import com.hl.base_module.util.screen.DensityUtil;
import com.hl.lib_miniui.view.Text_Badge;
...
public class HomeBottomNavigationActivity extends BaseWithServiceActivity<ActivityHomeBottomnavigationBinding> {
    ...
    public void initLayout(Context context) {
        ...
        // @添加到ViewPaper
        getViewDataBinding().ahbContentVp.setAdapter(new FragmentPagerAdapter(
    ...
    public void eventHandler(final Context context) {
        ...
        // Viewpaper滑动切换底部菜单
        getViewDataBinding().ahbContentVp.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
