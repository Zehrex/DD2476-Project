160
https://raw.githubusercontent.com/c0ny1/java-object-searcher/master/src/test/java/me/gv7/tools/josearcher/searcher/SearchRequstByRecursive1.java
/**
 * author: c0ny1
 ...
 */
public class SearchRequstByRecursive1 {
    private Logger logger = Logger.getLogger(SearchRequstByRecursive1.class);
    private String model_name = SearchRequstByRecursive1.class.getSimpleName();
    ...
    public SearchRequstByRecursive1(Object target, List<Keyword> keys){
        this.target = target;
        this.keys = keys;
