23
https://raw.githubusercontent.com/WeBankFinTech/Exchangis/master/modules/executor/engine/datax/datax-core/src/main/java/com/alibaba/datax/common/statistics/PerfRecord.java
...
public class PerfRecord implements Comparable<PerfRecord> {
    ...
    public String toString() {
        return String.format("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s"
                ...
                DateFormatUtils.format(startTime, datetimeFormat), elapsedTimeInNs, count.get(), size.get(), getHostIP());
    }
