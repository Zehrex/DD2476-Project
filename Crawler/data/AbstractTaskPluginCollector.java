23
https://raw.githubusercontent.com/WeBankFinTech/Exchangis/master/modules/executor/engine/datax/datax-core/src/main/java/com/alibaba/datax/core/statistics/plugin/task/AbstractTaskPluginCollector.java
...
public abstract class AbstractTaskPluginCollector extends TaskPluginCollector {
    ...
    @Override
    public void collectParameter(String key, String value, boolean isUnique) {
        this.communication.addParameter(key, value, isUnique);
    }
