2
https://raw.githubusercontent.com/AtomizedSoul/TulpApp/master/TulpApp.Android/obj/Release/90/android/src/mono/MonoPackageManager_Resources.java
package mono;
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TulpApp.Android.dll" comes first in this list. */
		"TulpApp.Android.dll",
		"FormsViewGroup.dll",
		"TulpApp.dll",
