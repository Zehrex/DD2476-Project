1
https://raw.githubusercontent.com/miaoo92/xxl-job-mongo/master/src/main/java/com/avon/rga/dao/XxlJobInfoService.java
...
public class XxlJobInfoService extends BaseMongoServiceImpl<XxlJobInfo> {
    ...
    public List<XxlJobInfo> pageList(int offset, int pagesize, int jobGroup, int triggerStatus,
    ...
    public long pageListCount(int offset, int pagesize, int jobGroup, int triggerStatus,
                              String jobDesc, String executorHandler, String author) {
        Query query = pageListQuery(offset, pagesize, jobGroup, triggerStatus, jobDesc, executorHandler, author);
    ...
    public int update(XxlJobInfo xxlJobInfo) {
        ...
        update.set("jobCron", xxlJobInfo.getJobCron());
    ...
    public int findAllCount() {
        return (int) super.count(new Query(where("_id").exists(true)));
    }
