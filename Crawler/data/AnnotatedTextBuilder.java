3
https://raw.githubusercontent.com/valentjn/ltex-ls-old/master/languagetool-patch/src/main/java/org/languagetool/markup/AnnotatedTextBuilder.java
...
public class AnnotatedTextBuilder {
  ...
  public AnnotatedText build() {
    ...
    mapping.add(new AbstractMap.SimpleEntry<>(0, 0));
    for (TextPart part : parts) {
      ...
      mapping.add(new AbstractMap.SimpleEntry<>(plainTextPosition, totalPosition));
    }
