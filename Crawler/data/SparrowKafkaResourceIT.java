2
https://raw.githubusercontent.com/Vondser/mmwms-antd/master/src/test/java/com/meimos/myapp/web/rest/SparrowKafkaResourceIT.java
...
import com.meimos.myapp.config.KafkaProperties;
...
class SparrowKafkaResourceIT {
    ...
    void setup() {
        ...
        SparrowKafkaResource kafkaResource = new SparrowKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/sparrow-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/sparrow-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
