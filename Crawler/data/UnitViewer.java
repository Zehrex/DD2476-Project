2
https://raw.githubusercontent.com/4156/MindustryModMaker/master/src/ProjectViewer/UnitViewer.java
package ProjectViewer;

import javax.swing.*;
import java.awt.*;

public class UnitViewer extends JFrame{
    public static JLabel picture,name,introduction;
    public static Container c1;
    public UnitViewer(String iconPath,String na,String into){
        c1=getContentPane();
        setLayout(null);
        setSize(500,500);
        picture=new JLabel();
