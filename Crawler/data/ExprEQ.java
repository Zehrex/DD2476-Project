3
https://raw.githubusercontent.com/RhenaudTheLukark/Lea2C/master/src/fr/ubordeaux/deptinfo/compilation/lea/abstract_syntax/ExprEQ.java
package fr.ubordeaux.deptinfo.compilation.lea.abstract_syntax;

import fr.ubordeaux.deptinfo.compilation.lea.environment.*;
import fr.ubordeaux.deptinfo.compilation.lea.type.*;

public class ExprEQ extends ExprBinary {

	public ExprEQ(Expr left, Expr right, int line, int column) throws Exception {
	...
	public void checkType() throws TypeException {
		...
		TypeCode[] typeCodes = {TypeCode.INTEGER, TypeCode.FLOAT, TypeCode.STRING, TypeCode.BOOLEAN, TypeCode.ENUM};
