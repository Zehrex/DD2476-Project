15
https://raw.githubusercontent.com/zjjxxlgb/mybatis2sql/master/src/test/java/org/apache/ibatis/submitted/awful_table/AwfulTableTest.java
/**
...
class AwfulTableTest {
  ...
  void testAwfulTableInsert() {
    try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
      ...
      AwfulTable3 record = new AwfulTable3();
      ...
      AwfulTable3 returnedRecord = mapper.selectByPrimaryKey(generatedCustomerId);
