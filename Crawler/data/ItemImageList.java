10
https://raw.githubusercontent.com/NearbyShops/Nearby-Shops-Android-app/master/app/src/main/java/org/nearbyshops/enduserappnew/ImageList/ImageListForItem/ItemImageList.java
...
//        setSupportActionBar(toolbar);
        ...
        if(savedInstanceState==null)
        {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragment_container,new ItemImageListFragment(),TAG_STEP_ONE)
                    .commitNow();
        }
