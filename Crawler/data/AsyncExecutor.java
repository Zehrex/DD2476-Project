7
https://raw.githubusercontent.com/chenjk-520/keventbus/master/keventbus/src/main/java/com/util/keventbus/util/AsyncExecutor.java
/*
...
public class AsyncExecutor {
    ...
    public static class Builder {
        ...
        public Builder eventBus(KeventBus eventBus) {
    ...
    private final KeventBus eventBus;
    private final Object scope;

    private AsyncExecutor(Executor threadPool, KeventBus eventBus, Class<?> failureEventType, Object scope) {
        this.threadPool = threadPool;
        this.eventBus = eventBus;
        this.scope = scope;
        try {
...
//                        event = failureEventConstructor.newInstance(e);
                        event = new EventMessage(null,ExceptionKey.METHOD_EXCEPTION);
                        event.setEventExeption(new EventMessage.PostEventExeption(-1,e.getMessage()));
                    } catch (Exception e1) {
