10
https://raw.githubusercontent.com/NearbyShops/Nearby-Shops-Android-app/master/app/src/main/java/org/nearbyshops/enduserappnew/UtilityScreens/PlacePickerGoogleMaps/PlacePickerWithMapFragment.java
...
import org.nearbyshops.enduserappnew.Model.ModelUtility.LocationWithAddress;
...
//    @BindView(R.id.progress_bar_selected) ProgressBar progressBarSelected;
    ...
    void myLocation()
    {
        ...
        if(googleMapInstance!=null)
        {
            ...
            LatLng latLng = new LatLng(PrefLocation.getLatitude(getActivity()),
