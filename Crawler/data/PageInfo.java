22
https://raw.githubusercontent.com/geekidea/spring-cloud-plus/master/scp-common/scp-common-core/src/main/java/io/geekidea/cloud/common/core/pagination/PageInfo.java
/*
...
package io.geekidea.cloud.common.core.pagination;
...
public class PageInfo<T> extends Page<T> {
     ...
     * 分页参数
     */
    private BasePageQuery pageQuery;
     ...
     * @param pageQuery
     */
    public PageInfo(BasePageQuery pageQuery) {
        this(pageQuery, null, null);
    }
     ...
     */
    public PageInfo(BasePageQuery basePageQuery, OrderItem defaultOrderItem) {
        this(basePageQuery, defaultOrderItem, null);
    }
     ...
     * @param orderMapping
     */
    public PageInfo(BasePageQuery pageQuery, OrderMapping orderMapping) {
        this(pageQuery, null, orderMapping);
    }
     ...
     * @param orderMapping
     */
    public PageInfo(BasePageQuery pageQuery, OrderItem defaultOrderItem, OrderMapping orderMapping) {
    ...
    /**
     * 如果是pageQuery是OrderPageParam，并且不为空，则使用前端排序
     * 否则使用默认排序
     */
    private void handle() {
        if (pageQuery == null) {
        ...
        super.setCurrent(pageQuery.getPageIndex());
        super.setSize(pageQuery.getPageSize());
        // 排序字段处理
        BasePageOrderQuery basePageOrderParam = (BasePageOrderQuery) pageQuery;
