4
https://raw.githubusercontent.com/abdalmoniem/Movie-App/master/base/src/main/java/butter/droid/base/content/preferences/PreferencesHandler.java
            ...
            prefItems.add(PrefItem.newBuilder(context)
                    ...
                    .setOnClickListener(new PrefItem.OnClickListener() {
                        ...
                        public void onClick(final PrefItem item) {
                            ...
                            handler.openListSelection(item.getTitle(), items, SelectionMode.SIMPLE_CHOICE, Arrays.asList(items).indexOf(item.getValue()), 0, 0, new OnSelectionListener() {
                                @Override
                                public void onSelection(int position, Object value) {
                                    item.saveValue(items[position]);
                                }
                            });
                        }
                    })
