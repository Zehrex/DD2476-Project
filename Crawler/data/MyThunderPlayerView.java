2
https://raw.githubusercontent.com/Aivacom/JLYMeet-android/master/app/src/main/java/com/mediaroom/ui/MyThunderPlayerView.java
 ...
 * @since 2019/12/26
 */
public class MyThunderPlayerView extends RelativeLayout implements OnRemoteListener {
    ...
    public void joinRoom(String UID) {
        ...
        tvUID.setText(UID);
        tvNetStatus.setVisibility(GONE);
        RoomManager.getInstance(getContext()).setRemotePlayerView(mThunderPlayerView, UID);
        isInRoom = true;
    }
