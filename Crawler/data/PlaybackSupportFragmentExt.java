9
https://raw.githubusercontent.com/idanapp/IdanPlusPlus/master/app/src/main/java/com/example/idan/plusplus/Support/PlaybackSupportFragmentExt.java
...
public class PlaybackSupportFragmentExt extends Fragment {
    ...
    RowsSupportFragmentExt mRowsSupportFragment;
    ...
    private final PlaybackSupportFragmentExt.SetSelectionRunnable mSetSelectionRunnable = new PlaybackSupportFragmentExt.SetSelectionRunnable();
    ...
    private static final String TAG = "PlaybackSupportFragmen";
    ...
    PlaybackSupportFragmentExt.OnFadeCompleteListener mFadeCompleteListener;
    ...
    public PlaybackSupportFragmentExt() {
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public void setFadeCompleteListener(PlaybackSupportFragmentExt.OnFadeCompleteListener listener) {
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public PlaybackSupportFragmentExt.OnFadeCompleteListener getFadeCompleteListener() {
    ...
    private boolean onInterceptInputEvent(InputEvent event) {
        ...
        if (event instanceof KeyEvent) {
            ...
            keyAction = ((MotionEvent) event).getAction() == MotionEvent.ACTION_UP ? KeyEvent.ACTION_UP : KeyEvent.ACTION_DOWN;
            KeyEvent tempEvent = new KeyEvent(keyAction,keyCode);
            consumeEvent = mInputEventHandler.onKey(getView(), keyCode,tempEvent);
        }
    ...
    private void loadBgAnimator() {
        ...
        mBgFadeInAnimator = loadAnimator(context, androidx.leanback.R.animator.lb_playback_bg_fade_in);
        mBgFadeInAnimator.addUpdateListener(listener);
        mBgFadeInAnimator.addListener(mFadeListener);

        mBgFadeOutAnimator = loadAnimator(context, androidx.leanback.R.animator.lb_playback_bg_fade_out);
        mBgFadeOutAnimator.addUpdateListener(listener);
        mBgFadeOutAnimator.addListener(mFadeListener);
    }

    private TimeInterpolator mLogDecelerateInterpolator = new com.example.idan.plusplus.Support.LogDecelerateInterpolator(100, 0);
    private TimeInterpolator mLogAccelerateInterpolator = new com.example.idan.plusplus.Support.LogDecelerateInterpolator(100, 0);
    ...
    private void loadControlRowAnimator() {
        ...
        Context context = getContext();
        mControlRowFadeInAnimator = loadAnimator(context, androidx.leanback.R.animator.lb_playback_controls_fade_in);
        ...
        mControlRowFadeOutAnimator = loadAnimator(context,
                androidx.leanback.R.animator.lb_playback_controls_fade_out);
    ...
    private void loadOtherRowAnimator() {
        ...
        Context context = getContext();
        mOtherRowFadeInAnimator = loadAnimator(context, androidx.leanback.R.animator.lb_playback_controls_fade_in);
        ...
        mOtherRowFadeOutAnimator = loadAnimator(context, androidx.leanback.R.animator.lb_playback_controls_fade_out);
    ...
    void showControlsOverlay(boolean show, boolean animation) {
        ...
        if (animation) {
            getView().announceForAccessibility(getString(show
                    ? androidx.leanback.R.string.lb_playback_controls_shown
                    : androidx.leanback.R.string.lb_playback_controls_hidden));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOtherRowsCenterToBottom = getResources()
                .getDimensionPixelSize(androidx.leanback.R.dimen.lb_playback_other_rows_center_to_bottom);
        mPaddingBottom =
                getResources().getDimensionPixelSize(androidx.leanback.R.dimen.lb_playback_controls_padding_bottom);
        mBgDarkColor =
                getResources().getColor(androidx.leanback.R.color.lb_playback_controls_background_dark);
        mBgLightColor =
                getResources().getColor(androidx.leanback.R.color.lb_playback_controls_background_light);
        mShowTimeMs =
                getResources().getInteger(androidx.leanback.R.integer.lb_playback_controls_show_time_ms);
        mMajorFadeTranslateY =
                getResources().getDimensionPixelSize(androidx.leanback.R.dimen.lb_playback_major_fade_translate_y);
        mMinorFadeTranslateY =
                getResources().getDimensionPixelSize(androidx.leanback.R.dimen.lb_playback_minor_fade_translate_y);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(androidx.leanback.R.layout.lb_playback_fragment, container, false);
        mBackgroundView = mRootView.findViewById(androidx.leanback.R.id.playback_fragment_background);
        mRowsSupportFragment = (RowsSupportFragmentExt) getChildFragmentManager().findFragmentById(
                androidx.leanback.R.id.playback_controls_dock);
        if (mRowsSupportFragment == null) {
            mRowsSupportFragment = new RowsSupportFragmentExt();
            getChildFragmentManager().beginTransaction()
                    .replace(androidx.leanback.R.id.playback_controls_dock, mRowsSupportFragment)
                    .commit();
        }
        if (mAdapter == null) {
