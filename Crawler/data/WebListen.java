11
https://raw.githubusercontent.com/mathuraveeraganesh/SeleniumWorkOut/master/src/main/java/week1/WebListen.java
package week1;
...
public class WebListen implements WebDriverEventListener {
	...
	public void beforeClickOn(WebElement element, WebDriver driver) {
		if (driver.findElements(By.xpath("//div[contains(@class,'Notify')]")).size()>0)
