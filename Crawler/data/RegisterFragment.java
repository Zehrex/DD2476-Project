14
https://raw.githubusercontent.com/FanChael/MVVM/master/modules/module_login/src/main/java/com/hl/modules_login/view/fragment/RegisterFragment.java
    ...
    public void requestData(Context context) {
        ...
        userViewModel.getUserLiveData().observe(this, new Observer<UserBean>() {
            ...
            public void onChanged(UserBean userBean) {
                ...
                intent.putExtra("user", "注册成功，我叫" + userBean.getUsername());
