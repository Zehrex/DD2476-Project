10
https://raw.githubusercontent.com/NearbyShops/Nearby-Shops-Android-app/master/app/src/main/java/org/nearbyshops/enduserappnew/aSellerModule/ItemsInShopSeller/ItemsInShop.java
package org.nearbyshops.enduserappnew.aSellerModule.ItemsInShopSeller;
...
//            slidingLayer.setPreviewOffsetDistance(15);
            ...
            if(getSupportFragmentManager().findFragmentByTag(TAG_SLIDING)==null)
            {
                ...
                getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.slidinglayerfragment,new SlidingLayerSortItemsInShopSeller(),TAG_SLIDING)
                        .commit();
            }
        }
