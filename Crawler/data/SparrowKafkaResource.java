2
https://raw.githubusercontent.com/Vondser/mmwms-antd/master/src/main/java/com/meimos/myapp/web/rest/SparrowKafkaResource.java
...
@RestController
@RequestMapping("/api/sparrow-kafka")
public class SparrowKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SparrowKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SparrowKafkaResource(KafkaProperties kafkaProperties) {
