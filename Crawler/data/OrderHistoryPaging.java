10
https://raw.githubusercontent.com/NearbyShops/Nearby-Shops-Android-app/master/app/src/main/java/org/nearbyshops/enduserappnew/Lists/OrderHistoryPaging/OrderHistoryPaging.java
...
public class OrderHistoryPaging extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getBooleanExtra(OrderHistoryPaging.IS_FILTER_BY_SHOP,false))
        {
            filterByShopID = true;
        }
        ...
        if (getSupportFragmentManager().findFragmentByTag("order_history_fragment") == null) {
            getSupportFragmentManager()
                    ...
                    .replace(R.id.fragment_container,
                            OrdersListPagingFragment.newInstance(false,filterByShopID,false),
