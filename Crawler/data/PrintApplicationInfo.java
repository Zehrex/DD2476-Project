22
https://raw.githubusercontent.com/geekidea/spring-cloud-plus/master/scp-common/scp-common-core/src/main/java/io/geekidea/cloud/common/core/util/PrintApplicationInfo.java
/*
...
public class PrintApplicationInfo {
    ...
    public static void printTip(ConfigurableApplicationContext context) {
        ...
        tip.append(" 7.如开发中遇到bug及问题，欢迎提交ISSUES：https://github.com/geekidea/spring-cloud-plus/issues\n");
    ...
    public static void print(ConfigurableApplicationContext context) {
        ...
        // 项目IP或域名地址
        String serverIp = environment.getProperty("spring-cloud-plus.server-ip");
        // 项目端口
