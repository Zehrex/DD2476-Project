4
https://raw.githubusercontent.com/abdalmoniem/Movie-App/master/base/src/main/java/butter/droid/base/utils/PrefUtils.java
/*
...
public class PrefUtils {
    ...
    public static String get(Context context, String key, String defaultValue) {
        ObscuredSharedPreferences obscuredSharedPreferences = getPrefs(context);
        if (obscuredSharedPreferences != null) {
            return obscuredSharedPreferences.getString(key, defaultValue);
        } else {
            return defaultValue;
        }
    }
