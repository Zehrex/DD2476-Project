3
https://raw.githubusercontent.com/RhenaudTheLukark/Lea2C/master/src/fr/ubordeaux/deptinfo/compilation/lea/abstract_syntax/ExprMOD.java
package fr.ubordeaux.deptinfo.compilation.lea.abstract_syntax;

import fr.ubordeaux.deptinfo.compilation.lea.environment.*;
import fr.ubordeaux.deptinfo.compilation.lea.type.*;

public class ExprMOD extends ExprBinary {

	public ExprMOD(Expr left, Expr right, int line, int column) throws Exception {
	...
	public void checkType() throws TypeException {
		...
		getLeft().getType().assertType(this, TypeCode.INTEGER);
