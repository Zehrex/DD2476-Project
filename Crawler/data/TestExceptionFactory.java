12
https://raw.githubusercontent.com/Col-E/SimAnalyzer/master/src/test/java/me/coley/analysis/design/TestExceptionFactory.java
...
public class TestExceptionFactory extends TestUtils {
		...
		for(MethodNode mn : node.methods) {
			SimAnalyzer analyzer = new SimAnalyzer(new SimInterpreter()) {
				...
				protected ResolvableExceptionFactory createExceptionFactory() {
					return new ResolvableExceptionFactoryTestImpl(createTypeChecker());
				}
			};
	...
	static class ResolvableExceptionFactoryTestImpl  extends ResolvableExceptionFactory {
		public ResolvableExceptionFactoryTestImpl(TypeChecker typeChecker) {
			super(typeChecker);
		}
