14
https://raw.githubusercontent.com/FanChael/MVVM/master/librarys/lib_common/src/main/java/com/hl/base_module/adapter/BaseMutilayoutAdapter.java
...
public abstract class BaseMutilayoutAdapter<T extends BaseMulDataModel> extends RecyclerView.Adapter<BaseMulViewHolder> {
    ...
    public BaseMulViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        BaseMulViewHolder baseMulViewHolder = null;
        try {
            baseMulViewHolder = getHolder(contextWeakReference.get(), viewGroup, viewType);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected abstract BaseMulViewHolder getHolder(Context context, ViewGroup parent, int viewType) throws Exception;
