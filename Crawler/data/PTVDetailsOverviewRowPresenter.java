4
https://raw.githubusercontent.com/abdalmoniem/Movie-App/master/tv/src/main/java/androidx/leanback/widget/PTVDetailsOverviewRowPresenter.java
/*
 ...
 * {@link #PTVDetailsOverviewRowPresenter(Presenter)}.  Typically this will be an instance of
 ...
 *
 * <p>
 * Because transition support and layout are fully controlled by PTVDetailsOverviewRowPresenter,
 * developer can not override PTVDetailsOverviewRowPresenter.ViewHolder for adding/replacing views
 * of PTVDetailsOverviewRowPresenter.  If further customization is required beyond replacing
 * the detailed description, the application should create a new row presenter class.
 * </p>
 */
public class PTVDetailsOverviewRowPresenter extends RowPresenter {

    private static final String TAG = "PTVDetOvervRowPres";
    ...
    class ActionsItemBridgeAdapter extends ItemBridgeAdapter {
        PTVDetailsOverviewRowPresenter.ViewHolder mViewHolder;

        ActionsItemBridgeAdapter(PTVDetailsOverviewRowPresenter.ViewHolder viewHolder) {
    ...
    private PTVDetailsOverviewSharedElementHelper mSharedElementHelper;

    /**
     * Constructor for a PTVDetailsOverviewRowPresenter.
     *
     * @param detailsPresenter The {@link Presenter} used to render the detailed
     *        description of the row.
     */
    public PTVDetailsOverviewRowPresenter(Presenter detailsPresenter) {
    ...
    public final void setSharedElementEnterTransition(Activity activity,
        ...
        if (mSharedElementHelper == null) {
            mSharedElementHelper = new PTVDetailsOverviewSharedElementHelper();
        }
