2
https://raw.githubusercontent.com/KarogathModdingStudios/Enhanced-Vanilla-1.15/master/src/main/java/com/karogath/enhancedvanilla/block/RedSandRippleBlock.java
...
public class RedSandRippleBlock extends EnhancedVanillaElements.ModElement {
	@ObjectHolder("enhancedvanilla:redsandripple")
	public static final Block block = null;
	public RedSandRippleBlock(EnhancedVanillaElements instance) {
		super(instance, 21);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("redsandripple", "redsandripple", blockAt -> {
